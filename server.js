...
app.get('/', (req, res) => {
    ...
    let url = 'https://api.themoviedb.org/3/movie/2316?api_key=1fd2bc63f763aee716a133acc40a3b66';
    axios.get(url)
    .then(response => {
...
app.post('/search', (req, res) => {
    ...
    let movieUrl = `https://api.themoviedb.org/3/search/movie?api_key=1fd2bc63f763aee716a133acc40a3b66&query=${movieTitle}`;
    let genres = 'https://api.themoviedb.org/3/genre/movie/list?api_key=1fd2bc63f763aee716a133acc40a3b66&language=en-US';
